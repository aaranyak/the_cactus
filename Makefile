...
SOURCES = main.c bitboard_utils.c move_utils.c move_gen_utils.c init_magics.c make_move.c legality_test.c evaluation.c perft_test.c search.c quiescence.c move_ordering.c zobrist_hash.c tp_table.c killer_moves.c $(MOVE_GEN_SOURCES) # gui_game.c # All source files

all: $(SOURCES)
	$(CC) -Wno-format-overflow -Wno-deprecated-declarations $(CFLAGS) -o $(NAME) $(SOURCES) $(LDFLAGS) 
